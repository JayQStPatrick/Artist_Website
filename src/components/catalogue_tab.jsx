    ...
    <div className="">
      ...
      <div className="p-6">
        ...
        <div className="lg:p-5">
          <div class="flex flex-col w-3/4 mx-auto md:min-w-2/6 md:flex-row lg:float-left clear-both display-table lg:w-2/5">
          ...
          <div class="flex flex-col w-3/4 mx-auto md:min-w-2/6 md:flex-row lg:float-right clear-both display-table lg:w-2/5">
            <div className="md:w-1/2 md:p-3">
              <img class="w-full" src={Pac} alt="HipHop Artist" />
            </div>
            <div class="md:w-3/4 md:p-3">
